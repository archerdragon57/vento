...
namespace Vento.CMS
{
    public partial class TwitterFeeds : System.Web.UI.Page
    {
        ...
        protected void GridView1_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            cmd = new SqlCommand("DELETE FROM [dbo].[twitter_feeds] WHERE [id] = " + GridView1.DataKeys[e.Item.ItemIndex].ToString() + "", con);
            con.Open();
        ...
        {
            Session["Twit_ID"] = Convert.ToString(GridView1.DataKeys[e.Item.ItemIndex]);
            Response.Redirect("edit/twit_feed.aspx?edit=" + GridView1.DataKeys[e.Item.ItemIndex].ToString(), false);
        }
