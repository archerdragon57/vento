...
namespace Vento.CMS
{
    public partial class InstagramFeeds : System.Web.UI.Page
    {
        ...
        protected void GridView1_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            cmd = new SqlCommand("DELETE FROM [dbo].[InstagramFeeds] WHERE [id] = " + GridView1.DataKeys[e.Item.ItemIndex].ToString() + "", con);
            con.Open();
        ...
        {
            Session["Insta_ID"] = Convert.ToString(GridView1.DataKeys[e.Item.ItemIndex]);
            Response.Redirect("edit/instagram_feed.aspx?edit=" + GridView1.DataKeys[e.Item.ItemIndex].ToString(), false);
        }
