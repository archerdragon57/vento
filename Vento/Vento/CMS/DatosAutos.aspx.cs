...
namespace Vento.CMS
{
    public partial class DatosAutos : System.Web.UI.Page
    {
        ...
        protected void GridView1_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            cmd = new SqlCommand("DELETE FROM [dbo].[cars] WHERE [id] = " + GridView1.DataKeys[e.Item.ItemIndex].ToString() + "", con);
            con.Open();
        ...
        {
            Session["Car_ID"] = Convert.ToString(GridView1.DataKeys[e.Item.ItemIndex]);
            Response.Redirect("edit/car_data.aspx?edit=" + GridView1.DataKeys[e.Item.ItemIndex].ToString(), false);
        }
