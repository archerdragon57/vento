...
namespace Vento.CMS
{
    public partial class Usuarios : System.Web.UI.Page
    {
        ...
        protected void GridView1_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            cmd = new SqlCommand("DELETE FROM [dbo].[users_travel] WHERE [id] = " + GridView1.DataKeys[e.Item.ItemIndex].ToString() + "", con);
            con.Open();
        ...
        {
            con = new SqlConnection(dbcon);
            da = new SqlDataAdapter("SELECT * from users_travel", con);
            ds = new DataSet();
